...
* Event ```userinfoLoaded.metabrag``` : Triggered after DOM has loaded user info from github
* Event ```repoinfoLoaded.metabrag``` : Triggered after DOM has loaded repo info from github
* Event ```badgesLoaded.metabrag``` : Triggered after DOM has loaded badges from Coderwall
